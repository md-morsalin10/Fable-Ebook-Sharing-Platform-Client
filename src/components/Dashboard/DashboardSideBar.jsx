      ...
      >
        {isPending ? (
          ...
          navItems.map((item) => {
            ...
            return (
              <motion.div key={item.label} variants={itemVariants} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Link
                  href={item.href}
  ...
  return (
    <>
      ...
      <motion.aside 
        ...
        className="hidden lg:block w-64 h-full flex-shrink-0 bg-[#0B0F17]"
      >
        {navContent}
      </motion.aside>
