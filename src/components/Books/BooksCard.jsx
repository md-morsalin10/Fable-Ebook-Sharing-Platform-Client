  ...
  return (
    <motion.div whileHover={{ y: -6 }} transition={{ duration: 0.25, ease: "easeOut" }} className="h-full">
      <Link
        ...
        className="group bg-[#0B0F17] border border-gray-800/60 rounded-2xl p-4 shadow-md hover:border-[#E5BA73]/20 hover:shadow-2xl transition-all duration-300 flex flex-col justify-between cursor-pointer focus:outline-none focus:border-[#E5BA73] h-full"
      >
        <div>
          {/* Cover Image */}
